Locales['fr'] = {
	...
	['bodyb'] = 'opacité des imperfections',
	  ...
	  ['robbery_timer'] = 'braquage magasin: il reste ~b~%s~s~ secondes',
	  ['recently_robbed'] = 'ce magasin a déjà été braqué. Attendez ~b~%s~b~ secondes.',
	  ['rob_in_prog'] = '~b~Braquage en cours à: ~b~%s~s~',
	  ['started_to_rob'] = 'vous avez commencé à braquer ~b~%s~s~',
	  ['alarm_triggered'] = 'l\'alarme a été déclenchée',
	  ['robbery_complete'] = '~b~Braquage terminé~s~. Vous avez ~o~volé~s~ ~g~$%s~s~',
	  ['robbery_complete_at'] = '~b~Braquage terminé à: ~b~%s~s~',
	  ['robbery_cancelled'] = 'le braquage va être annulé, vous ne gagnerez rien!',
	  ['robbery_cancelled_at'] = '~b~Braquage annulé à: ~b~%s~s~',
	  ['min_police'] = 'il faut minimum ~b~%s policiers~s~ en ville pour braquer.',
	  ['robbery_already'] = '~b~Un braquage est déjà en cours.',
	  ...
	  ['invoices'] = 'factures',
	  ['invoices_item'] = '$%s',
	  ['received_invoice'] = 'vous avez ~b~reçu~s~ une facture',
	  ['paid_invoice'] = 'vous avez ~g~payé~s~ une facture de ~b~$%s~s~',
	  ...
	  ['target_no_money'] = 'the player ~b~does not~s~ have enough money to pay the bill!',
