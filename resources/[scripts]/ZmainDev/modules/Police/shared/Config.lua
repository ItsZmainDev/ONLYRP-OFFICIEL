Config_Police = {
    ...
    Position = {
        cloakroom = vector3(-1098.238, -831.1566, 14.28278),
        chest = vector3(-1085.224, -810.8539, 11.03728),
        boss = vector3(-1114.079, -832.7947, 30.75703),
        armory = vector3(847.2218, -1312.285, 28.24493),
        accueil = vector3(837.183, -1288.121, 28.24492),
    },
