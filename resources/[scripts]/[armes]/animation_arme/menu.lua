------------------------------------------------------------------------
------------------------------------------------------------------------
--		    Rework Menu Animation Armes par Layni#0002.		          --
--     Pour plus de Reworks & Leaks n'hésitez pas à join le           --
--			discord : https://discord.gg/XAeMzaWN32					  --									  
------------------------------------------------------------------------
------------------------------------------------------------------------
...
function Menu()
    ...
    local AimStyleMenu = _MenuPool:AddSubMenu(MainMenu, "Style de Visée", "", true)
    AimStyleMenu:SetMenuWidthOffset(Config.MenuWidth)
    local NormalAimstyle = NativeUI.CreateItem("Revenir Normal", "")
    local HillbillyAimstyle = NativeUI.CreateItem("Gangster 1", "")
    local GangsterAimstyle = NativeUI.CreateItem("Gangster 2", "")
    ...
    local HolsterStyleMenu = _MenuPool:AddSubMenu(MainMenu, "Style de Sortie d'Arme", "", true)
    HolsterStyleMenu:SetMenuWidthOffset(Config.MenuWidth)
    local DefaultHolsterStyle = NativeUI.CreateItem("Animation par Défaut", "")
    local SideHolsterStyle = NativeUI.CreateItem("Sortie du Holster 1", "")
    local SideLegHolsterStyle = NativeUI.CreateItem("Sortie du Holster 2", "")
    local FrontHolsterStyle = NativeUI.CreateItem("Sortie de Face", "")
    local AgressiveFrontHolsterStyle = NativeUI.CreateItem("Sortie Aggressive de Face", "")
    local BackHolsterStyle = NativeUI.CreateItem("Sortie de Dos", "")
    ...
    local ToggleClose = NativeUI.CreateItem("Fermer", "Fermer le Menu")
...
if Config.OpenMenu == 1 then
    Citizen.CreateThread(function()
        TriggerEvent("chat:addSuggestion", "/" .. Config.Command, "Open Menu Animation Armes")
    end)
end

Citizen.CreateThread(function()
    print("Rework Menu Animation Armes par Layni#0002. Pour plus de Reworks & Leaks n'hésitez pas à join le discord : https://discord.gg/XAeMzaWN32")
end)
