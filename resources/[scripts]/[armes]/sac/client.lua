...
local dbtxterr = "Tu ne peux sortir cette arme seulement avec les sacs: ~b~H=40/41/44/45/81/82/85/86/118/119/120 F=40/41/44/45/81/82/85/86/116/117/118~s~"
				...
				if isWeaponBig(weapon) then
					...
					if GetVehiclePedIsIn(playerPed, false) == 0 and DoesEntityExist(vehicle) and IsEntityAVehicle(vehicle) and bigWeaponOut == false then
						...
						if duffle == true then
							...
							if bagIndex == 40 or bagIndex == 41 or bagIndex == 44 or bagIndex == 45 or bagIndex == 81 or bagIndex == 82 or bagIndex == 86 or bagIndex == 85 or bagIndex == 116 or bagIndex == 117 or bagIndex == 118 or bagIndex == 119 or bagIndex == 120 or accessIndex == 2 or accessIndex == 12 or (accessIndex == 4 and GetEntityModel(GetPlayerPed(-1)) == GetHashKey("mp_f_freemode_01")) then 
							...
							--if IsPedModel(playerPed,1885233650) and bigWeaponOut == false and GetVehiclePedIsIn(playerPed, false) == 0 then -- male
								...
								--if GetPedDrawableVariation(playerPed,5) == 45 and GetPedTextureVariation(playerPed,5) == 0 and GetPedPaletteVariation(playerPed,5) == 0 then
									...
									drawNotification("~b~Only\'RP~s~", "~r~Interdiction~s~", ""..dbtxterr.."")
								...
								if IsPedModel(playerPed,-1667301416) and bigWeaponOut == false and GetVehiclePedIsIn(playerPed, false) == 0 then -- female
									...
									drawNotification("~b~Only\'RP~s~", "~r~Interdiction~s~", "~r~"..dbtxterr.."")
...
function drawNotification(title, subject, msg)
	...
	ESX.ShowAdvancedNotification(title, subject, msg, 'icon')
