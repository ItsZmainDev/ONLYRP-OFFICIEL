...
Config.Strings = {
	...
	EToRefuel = "Appuyer sur ~g~E ~w~pour mettre de l'essence",
	JerryCanEmpty = "Le jerrican est rempli",
	FullTank = "Le réservoir est plein",
	PurchaseJerryCan = "Appuyer sur ~g~E ~w~pour acheter le jerrican pour ~g~$" .. Config.JerryCanCost,
	...
	NotEnoughCash = "Pas assez de ~g~cash",
	RefillJerryCan = "Appuyer sur ~g~E ~w~ remplir le jerrican",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyer sur ~g~E ~w~prendre un jerrican"
	Config.Strings.RefillJerryCan = "Appuyer sur ~g~E ~w~pour remplir le jerrican"
end
