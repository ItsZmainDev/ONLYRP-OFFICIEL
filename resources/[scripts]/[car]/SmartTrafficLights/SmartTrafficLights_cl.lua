...
-- local TRAFFIC_LIGHT_POLL_FREQUENCY_MS = 3000    -- How often to check if a light is red (ms)
-- local TRAFFIC_LIGHT_DURATION_MS = 10000          -- Duration to turn light green (ms)
