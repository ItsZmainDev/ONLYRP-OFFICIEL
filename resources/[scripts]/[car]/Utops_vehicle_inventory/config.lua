...
Config_Vehicle_Inventory = {
    ...
    BlackListWeapon = {
        "WEAPON_NIGHTSTICK", "WEAPON_STUNGUN", "WEAPON_COMBATPISTOL", "WEAPON_BULLPUPSHOTGUN", "WEAPON_FLASHLIGHT", "WEAPON_ASSAULTSMG", "WEAPON_SMG", "WEAPON_CARBINERIFLE", "WEAPON_PUMPSHOTGUN"
    }
}