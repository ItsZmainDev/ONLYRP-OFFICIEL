Config.Weapons = {
	...
	{name = 'WEAPON_RAYCARBINE', 'ARME DE ZMAIN', components = {}},
	...
	{name = 'WEAPON_NAVYREVOLVER', label = 'Navy Revolver', components = {}},
	{name = 'WEAPON_GADGETPISTOL', label = 'Pistolet Cayo', components = {}},
	{name = 'WEAPON_COMBATSHOTGUN', label = 'Fusil a pompe de Combat', components = {}},
	{name = 'WEAPON_MILITARYRIFLE', label = 'Military Rifle', components = {}},
	{name = 'WEAPON_BLASTAK', label = 'AK Blastak', components = {}},
	{name = 'WEAPON_PREDATOR', label = 'M4 Predator', components = {}},
	{name = 'WEAPON_STONE_HATCHET', label = 'Hache en Pierre', components = {}},
    {
        ...
        components = {
            ...
            -- SILENCIEUX
            {name = 'silencieux1', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_01`},
            {name = 'silencieux2', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_02`},
            {name = 'silencieux3', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_03`},
            {name = 'silencieux4', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_04`},
            {name = 'silencieux5', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_05`},
            {name = 'silencieux6', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_06`},
            {name = 'silencieux7', label = 'Silencieux ou Poingner', hash = `COMPONENT_SUPP_07`},
            -- Chargeur 
            ...
            -- Flashlights & Lasers
            {name = 'lumiere1', label = 'Lumière ou Lazer', hash = `COMPONENT_GLOCK_FLSH_01`},
            {name = 'lumiere2', label = 'Lumière ou Lazer', hash = `COMPONENT_GLOCK_FLSH_02`},
            {name = 'lumiere3', label = 'Lumière ou Lazer', hash = `COMPONENT_GLOCK_FLSH_03`},
            {name = 'lumiere4', label = 'Lumière ou Lazer', hash = `COMPONENT_GLOCK_FLSH_04`},
        }
	},
	{
		name = 'WEAPON_PISTOL',
	...
	{name = 'WEAPON_BAYONET', label = "Bayonette"},
	{name = 'WEAPON_CASABLANCA', label = "casablanca"},
	{name = 'WEAPON_HEAVYREVOLVER_MK2', label = "heavyrevolver_mk2"},
	{name = 'WEAPON_HUNTSMAN', label = "huntsman"},
	{name = 'WEAPON_KATANA', label = "Katana"},
	{name = 'WEAPON_STAINED', label = "stained"},
	{name = 'WEAPON_TRIDAGGERSILVER', label = "TriDagger Silver"}
}
