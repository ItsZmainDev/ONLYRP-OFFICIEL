...
--	for i = 1, #Config.GPS, 1 do
	...
	RMenu.Add('personal', 'admin', RageUI.CreateSubMenu(RMenu.Get('rageui', 'personal'), _U('admin_title')), function()
		if Player.group ~= nil and (Player.group == 'moderateur' or Player.group == 'administrateur' or Player.group == 'superadmin' or Player.group == 'fondateur' or Player.group == 'developper' or Player.group == 'responsable') then
			return true
		end
...
-- 			ESX.TriggerServerCallback('KorioZ-PersonalMenu:Admin_getUsergroup', function(plyGroup)
-- 				if plyGroup ~= nil and (plyGroup == 'moderateur' or plyGroup == 'administrateur' or plyGroup == 'superadmin' or plyGroup == 'fondateur' or plyGroup == 'developpeur' or plyGroup == 'responsable') then
