...
Config.Admin = {
	{
		...
		groups = {'helpeur', 'moderateur', 'administrateur', 'superadmin', 'responsable', 'developper', 'fondateur'},
		command = function()
	...
	},
	{
		...
		groups = {'administrateur', 'superadmin', 'responsable', 'developper', 'fondateur'},
		command = function()
	...
	},
	{
		...
		groups = {'moderateur', 'administrateur', 'superadmin', 'responsable', 'developper', 'fondateur'},
		command = function()
	...
	},
	{
		...
		groups = {'responsable' ,'developper', 'fondateur'},
		command = function()
	...
	},
	{
		...
		groups = {'superadmin', 'responsable', 'developper', 'fondateur'},
		command = function()
	...
	},
	{
		...
		groups = {'developper', 'fondateur', 'superadmin'},
		command = function()
			RageUI.CloseAll()
			Citizen.Wait(100)
