Locales['fr'] = {
  ...
  -- Main Menu
  ['mainmenu_subtitle'] = '¦ ~h~~b~MENU INTERACTION',
  ...
  -- Vehicle Menu
  ['vehicle_title'] = '~b~~h~            Gestion Véhicule',
  ...
  ['bossmanagement_title'] = '~h~~b~            Gestion Entreprise',
  ...
  ['bossmanagement2_title'] = '~h~~b~            Gestion Organisation',
  ...
  -- Admin Menu
  ['admin_title'] = '∑ ~h~~r~         Administration',
