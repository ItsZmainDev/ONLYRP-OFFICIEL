Config = {}
Config.Blacklist    = true             --false TurnOff Blacklist mod, master of {BlacklistCar, BlacklistPed, BlacklistWeapon}
Config.Setting      = {
    ...
    unStamina               = true,    --true:     activera le sprint illimité
    ...
    BlacklistWeapon         = true,    --true:     activera l'option [forPlayer]    {need Config.Blacklist = true to work} 
    escMenutext             = false,    --true:     activera l'option du texte menu échap
    densityMultiplier       = true,    --true:     activera la gestion total de la densité pnj/voiture
    densityNpc              = true,    --true:     activera la gestion PNJ uniquement
    densityVeh              = true,    --true:     activera la gestion de la circulation véhicule PNJ uniquement     
    densityVehParked        = true,    --true:     activera la gestion des véhicule spawn (parked) aléatoirement uniquement
    npcRelationship         = true,    --true:     activera le fait que les pnj ne vous attaque pas
    npcNoDropWeapon         = true,    --true:     désactivera le drop des armes pnj
    noRewardVeh             = true,    --true:     déactivera les gain automatique gtaOnline d'armes dans les véhicule type police etc
    npcDispatchService      = true,    --true:     déactivera les amublancier / police etc... en service
    train                   = true,    --true:     activera les train
    afkCamPlayer            = true,    --true:     désactivera le passage de caméra en mode AFK
    hideHudonline           = true,    --true:     désactivera les hud gtaOnline
    hideHudWeapon           = true,    --true:     active {Config.HudWeapon} pour cacher les hud Weapon GTAonline et roue d'arme selon vos parametre
    setDamage				= true, 	--true: 	active le reglage de dêgat des armes --WIP
	recoilWeapon            = false,    --true:     activera le recul des armes --Work In Progress__ pour ajouter la cette gestion ici de facon opti
    noCrossHit              = true,    --true:     désactivera les coups de cross
    xMas                    = false,    --true:     activera la neige
    removeAllCopsCarPed     = true,    --true:     désactivera le spawn des véhicule Ped de police autour des joueurs (J'ai réussit a trouver le reglagle le plus opti et fonctionnel a la fois je pense car cette option consomme trop de radius sa pic les ms, wait trop long les vehicule spawn et trop court bouffe de ms xD)
}
...
Config.npcMultiplier    = 0.2   --(if densityNpc        = true) set 0 to delete npc
Config.npvehMultiplier  = 0.1   --(if densityVeh        = true) set 0 to clear npc driver
Config.pvehMultiplier   = 0   --(if densityVehParked  = true) set 0 to clear all veh parked
...
Config.HudWeapon = {
    hudweapon           = true,     --weapon top-right
    hudcompenents       = true,     --compenent trop-right
    wheel               = false,     --wheel list to get your weapon (+stats of weapon)
    reticle             = false,     --reticle... you know what is that? xD (crosshair)
    hudAmmo             = true,     --hide amooHud everytime (If you turnOn this, turnOff realisticAmmo)
...
--Weapon damage part--
Config.noCritikHits = true --if true, then headshot like a torso
...
Config.Setdamage = { --set damage of weapon you want and add weapon you want (-1.0 or 0.0 if you want weapon make 0 damage [dont forget number.number, number only not work])
	weapon = { --melee weapon
		setting = {
			{weaponhash = "WEAPON_BZGAS", value = 0.2},
			{weaponhash = "WEAPON_SMOKEGRENADE", value = 0.2},
			--{weaponhash = "WEAPON_UNARMED", value = 0.0},

			{weaponhash = "weapon_pistol", value = 0.5},
			{weaponhash = "weapon_combatpistol", value = 0.5},
			{weaponhash = "weapon_snspistol", value = 0.5},
			{weaponhash = "weapon_heavypistol", value = 0.5},
			{weaponhash = "weapon_pistol50", value = 0.6},
			{weaponhash = "weapon_navyrevolver", value = 0.6},
			{weaponhash = "weapon_revolver", value = 0.6},
			{weaponhash = "weapon_doubleaction", value = 0.6},
			{weaponhash = "weapon_machinepistol", value = 0.5},
			{weaponhash = "weapon_carbinerifle", value = 0.5},
			{weaponhash = "weapon_minismg", value = 0.5},
			{weaponhash = "weapon_microsmg", value = 0.5},
			{weaponhash = "weapon_dbshotgun", value = 0.7},
			{weaponhash = "weapon_combatshotgun", value = 0.5},
			{weaponhash = "weapon_assaultrifle", value = 0.4},
			{weaponhash = "weapon_specialcarbine", value = 0.4},
			{weaponhash = "weapon_compactrifle", value = 0.4},
			{weaponhash = "weapon_gusenberg", value = 0.4},
			{weaponhash = "weapon_smg", value = 0.4},
			{weaponhash = "weapon_smg_mk2", value = 0.4},
			{weaponhash = "weapon_assaultsmg", value = 0.4},
			{weaponhash = "weapon_sawnoffshotgun", value = 0.5},
			{weaponhash = "weapon_pumpshotgun", value = 0.5},
			{weaponhash = "weapon_dagger", value = 0.2},
			{weaponhash = "weapon_crowbar", value = 0.2},
			{weaponhash = "weapon_hatchet", value = 0.2},
			{weaponhash = "weapon_machete", value = 0.2},
			{weaponhash = "weapon_knuckle", value = 0.2},
			{weaponhash = "weapon_bat", value = 0.2},
			{weaponhash = "weapon_nightstick", value = 0.1},
			{weaponhash = "weapon_switchblade", value = 0.2},
			{weaponhash = "WEAPON_KNIFE", value = 0.2},
