...
admins = {
    ...
    'steam:110000111efcc44',
    'steam:110000111efcc44',
    'steam:110000140af6579',
    'steam:110000145513838',
    'steam:1100001357b2151',
    'steam:1100001357b2151',
    'steam:11000011d050441',
    'steam:110000149881a2e'
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(50000)
        local newBaseTime = os.date('*t')

        local argh = tonumber(newBaseTime.hour)
        local argm = tonumber(0)
        if argh < 24 then
            ShiftToHour(argh)
        else
            ShiftToHour(0)
        ...
        local minute = math.floor((baseTime+timeOffset)%60)
        if minute < 10 then
            baseTime = baseTime .. "0" .. minute
        else
            baseTime = newtime .. minute
        end
        TriggerEvent('vSync:requestSync')
